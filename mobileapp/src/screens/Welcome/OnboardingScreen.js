  ...
  main(title) {
    ...
    return (
      <SafeAreaView style={styles.exampleContainer}>
        <Image
          source={require('../../assets/images/white_logo_doroos.png')}
        ...
        <Text
          style={[
            styles.title,
            {...fonts.black, marginBottom: 10},
          ]}>{`Find your Teacher`}</Text>
        <Text
          style={[
            styles.subtitle,
            {marginBottom: 20, ...fonts.light, marginHorizontal: 20},
          ]}>
          {title}
        </Text>
        <Pagination
