        ...
        <View style={styles.drawerContent}>
            ...
            <View style={styles.userInfoSection}>
              <View style={{flexDirection: 'row', marginTop: 15}}>
                ...
                <View style={{marginHorizontal: 15, flexDirection: 'column'}}>
                  <Title style={[styles.title, {...fonts.cairoSemiBold}]}>
                    {user.full_name}
                  </Title>
                  <Caption
                    style={[
                      styles.caption,
                      {fontSize: 10, ...fonts.cairoSemiBold},
                    ]}>
                    {user.email}
                  </Caption>
                </View>
          ...
          <Drawer.Section style={styles.drawerSection}>
            ...
            {user ? (
              <DrawerItem
                icon={({color}) => (
                  <Feather name="lock" color={color} size={18} />
                )}
            ...
            <DrawerItem
              icon={({color}) => (
                <Feather name="headphones" color={color} size={18} />
              )}
            ...
            <DrawerItem
              icon={({color}) => (
                <FontAwesome name="language" color={color} size={18} />
              )}
              ...
              onPress={() =>
                language === 'ar' ? _changeLng('en') : _changeLng('ar')
              }
            />
          </Drawer.Section>
        </View>
